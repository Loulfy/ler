...
static constexpr DxgiFormatMapping c_FormatMappings[] = {
...
const DxgiFormatMapping& getDxgiFormatMapping(DXGI_FORMAT d3d12Format)
{
    ...
    for (const DxgiFormatMapping& mapping : c_FormatMappings)
    {
        if (mapping.srvFormat == d3d12Format)
            return mapping;
    }
    return c_FormatMappings[0];
}
} // namespace ler::rhi::d3d12